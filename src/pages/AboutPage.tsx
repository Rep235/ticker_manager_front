  ...
  const features = [
    {
      ...
      description: 'Roles de administrador y agente para operar con permisos claros.',
    },
    {
      icon: ListChecks,
    ...
    },
    {
      icon: Users2,
      title: 'Usuarios',
      description: 'Administra usuarios internos con visibilidad centralizada.',
    },
    {
      icon: MessageSquare,
      title: 'Comentarios y seguimiento',
      description: 'Documenta cada ticket con comentarios internos o visibles para el usuario.',
    },
  ];
    ...
    <div className="space-y-6">
      <div className="space-y-2">
        ...
        <p className="text-sm text-[var(--muted)]">
          Como administrador puedes configurar el equipo y flujos de tickets desde un solo lugar.
        </p>
      </div>
      ...
      <Card>
        ...
        <CardBody className="space-y-3">
          <ol className="list-decimal list-inside space-y-2 text-[var(--text)]">
            ...
            {/* Se eliminó la referencia a clientes */}
